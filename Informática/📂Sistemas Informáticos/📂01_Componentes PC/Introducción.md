...
- **Función principal**: Ejecuta instrucciones y cálculos que le envían los programas. Es el cerebro de la ordenador.
...
- **Ejemplo**: Sin ROM, la ordenador no sabría cómo encenderse ni encontrar el sistema operativo.
...
- **Función**: Convierte la corriente de la pared (AC) en la que la ordenador puede usar (DC).
