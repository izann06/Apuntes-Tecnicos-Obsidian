...
```mermaid
flowchart TD
    ROOT["🚀 Biblioteca Digital de Informática<br><b>Segundo Cerebro Técnico</b>"]

    subgraph SISTEMAS_INFRA["🖥️ Sistemas, Redes e Infraestructura"]
        LINUX["🐧 <b>Linux & Terminal</b><br><i>Arquitectura, Usuarios/Grupos, Permisos, Bash</i>"]
        REDES["🌐 <b>Redes Informáticas</b><br><i>OSI, TCP/IP, Switch, Router, Firewall, IP, MAC, Mascara, Packet Tracer...</i>"]
        SIST["⚙️ <b>Sistemas y Hardware</b><br><i>Transistores, Puertas Lógicas, Componentes, Packet Tracer Labs</i>"]
        IT["🛠️ <b>Soporte IT</b><br><i>Troubleshooting, BIOS/UEFI, Particiones</i>"]
    end

    subgraph CLOUD_DEVOPS["☁️ Cloud, DevOps y Seguridad"]
        AWS_CP["☁️ <b>AWS Cloud Practitioner</b><br><i>Infraestructura, Cómputo, Almacenamiento, BD, Seguridad, Desplegación...</i>"]
        AWS_AI["🧠 <b>AWS AI Practitioner</b><br><i>GenAI, Bedrock, RAG, Q, Embeddings...</i>"]
        DOCKER["🐳 <b>Docker & Virtualización</b><br><i>Contenedores, Volúmenes, Docker Compose</i>"]
        SEG["🛡️ <b>Ciberseguridad</b><br><i>Seguridad Digital, 2FA, Amenazas, VPN</i>"]
    ...
    subgraph DEV_SOFTWARE["💻 Desarrollo de Software"]
        ...
        CSHARP["🟪 <b>C# & WPF (.NET)</b><br><i>MVVM, Triggers, UserControls, Binding</i>"]
    end
    ...
    style LINUX fill:#14532d,stroke:#22c55e,color:#fff
    style REDES fill:#1e3a8a,stroke:#3b82f6,color:#fff
    style SIST fill:#312e81,stroke:#6366f1,color:#fff
    style IT fill:#374151,stroke:#9ca3af,color:#fff
    style AWS_CP fill:#713f12,stroke:#eab308,color:#fff
    style AWS_AI fill:#581c87,stroke:#c084fc,color:#fff
    ...
    style NODE fill:#064e3b,stroke:#10b981,color:#fff
```
