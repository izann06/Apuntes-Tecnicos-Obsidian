...
Un **equipo** es un subgrupo de miembros dentro de una organización. Permite asignar permisos a repositorios de forma colectiva en lugar de usuario a usuario.
...
Disponible en **GitHub Enterprise Cloud**, Team Sync conecta los equipos de GitHub con los **grupos de un proveedor de identidad (IdP)** externo.
...
- **Informes de consumo:** Descarga de informes CSV detallados con el consumo por usuario, repositorio y servicio.
