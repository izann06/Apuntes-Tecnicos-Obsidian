...
aliases:
  - "Estándares IEEE 802.11 (De Wi-Fi 4 a Wi-Fi 7)"
  - "Evolución Tecnológica de Redes Wi-Fi"
date: 2026-09-07
---

> [!info] 🧭 Navegación
> ◀ [[06.4 - Protocolos de Aplicación Comunes (HTTP-S, SSH, FTP, Correo y Gestión)]] · 🔼 [[00 - Índice Maestro de Redes]] · ▶ [[07.2 - Frecuencias, Canales, Celdas y Roaming]]

---

# 📡 07.1 - Estándares IEEE 802.11 (De Wi-Fi 4 a Wi-Fi 7)

## 1. El Nacimiento del Estándar Inalámbrico

En 1997, el Instituto de Ingenieros Eléctricos y Electrónicos (**IEEE**) publicó el estándar **802.11**, definiendo la capa física (Capa 1) y de enlace MAC (Capa 2) para comunicaciones inalámbricas de corto alcance mediante radiofrecuencia. Su velocidad original era de tan solo 2 Mbps.
...
## 2. Tabla Comparativa de Estándares IEEE 802.11
...
## 6. Perspectiva de Ciberseguridad: Coexistencia y Downgrade
...
> 1. **Degradación Global de la Red**: Si un dispositivo 802.11b antiguo se conecta a tu red, el router tiene que desacelerar sus transmisiones y utilizar preámbulos lentos para que ese cliente no se pierda, penalizando la velocidad de todos los dispositivos modernos del hogar.
...
En la siguiente nota ([[07.2 - Frecuencias, Canales, Celdas y Roaming]]), profundizaremos en el espectro radioeléctrico: el dilema entre **2.4 GHz vs 5 GHz vs 6 GHz**, cómo planificar canales sin solapamiento y cómo funciona el **Roaming** entre antenas.
