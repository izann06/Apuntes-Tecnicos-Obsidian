#redes #ccna #acls #firewalls #stateful #ngfw #dmz #iptables #ciberseguridad

> [!info] 🧭 Navegación
> ◀ [[☣️ 08.1 - Amenazas Comunes en Redes (Ataques Capas 2, 3 y 4)]] · 🔼 [[🌐 00 - Índice Maestro de Redes Informáticas]] · ▶ [[🛡️ 08.3 - VPNs (Redes Privadas Virtuales, IPsec y WireGuard)]]
...
### ⚖️ Comparativa: ACLs Estándar vs. ACLs Extendidas
...
## ⚙️ 4. Arquitectura de Zonas de Red y la DMZ (Zona Desmilitarizada)
...
En la siguiente nota ([[🛡️ 08.3 - VPNs (Redes Privadas Virtuales, IPsec y WireGuard)]]), analizo cómo extender el perímetro de la empresa de forma segura sobre Internet público mediante **túneles cifrados VPN**, **IPsec** y **WireGuard**.
