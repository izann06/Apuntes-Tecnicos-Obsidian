#redes #ccna #ciberseguridad #arp-spoofing #mac-flooding #syn-flood #dhcp-starvation #port-security #mitm

> [!info] 🧭 Navegación
> ◀ [[🔐 07.3 - Seguridad en Redes Inalámbricas (WPA2, WPA3 y Enterprise)]] · 🔼 [[🌐 00 - Índice Maestro de Redes Informáticas]] · ▶ [[🛡️ 08.2 - Mecanismos de Protección y Filtrado (ACLs, Firewalls y Zonas)]]

---

## 🛡️ 1. El Paradigma de la Seguridad en Redes: La Amenaza Interna
...
## 🛡️ 2. Ataques Críticos en Capa 2 (Enlace de Datos)
...
### ⚖️ 2.2 Inundación de Tabla CAM (*MAC Flooding*)
...
### ☁️ 2.3 DHCP Starvation y Servidor Rogue DHCP
...
## 🛡️ 3. Ataques Críticos en Capa 3 y Capa 4
...
### 🏛️ 3.2 SYN Flood (Inundación SYN en Capa 4)
...
## 🛡️ 4. Ataques de Intercepción: Man-in-the-Middle y SSL Stripping
...
En la siguiente nota ([[🛡️ 08.2 - Mecanismos de Protección y Filtrado (ACLs, Firewalls y Zonas)]]), aprenderemos a construir las defensas perimetrales e internas: **Listas de Control de Acceso (ACLs)**, firewalls **Stateless vs Stateful**, cortafuegos de nueva generación (**NGFW**) y diseño de zonas seguras con **DMZ**.
