...
aliases:
  - "VPNs (Redes Privadas Virtuales, IPsec y WireGuard)"
  - "Túneles Site-to-Site, Remote Access y Arquitectura IPsec"
date: 2026-09-07
---

> [!info] 🧭 Navegación
> ◀ [[08.2 - Mecanismos de Protección y Filtrado (ACLs, Firewalls y Zonas)]] · 🔼 [[00 - Índice Maestro de Redes]] · ▶ [[09.1 - Comandos Esenciales de Diagnóstico de Red (Linux y Windows)]]

---

# 🛡️ 08.3 - VPNs (Redes Privadas Virtuales, IPsec y WireGuard)
...
### 3.1 Modos de Operación: Transport Mode vs. Tunnel Mode
...
## 5. Perspectiva de Ciberseguridad: Mitos y Riesgos de las VPNs
...
> 4. **VPNs y Malware**: Una VPN cifra el túnel, **pero no desinfecta el contenido**. Si descargas un archivo con ransomware por un túnel VPN, llegará perfectamente cifrado y seguro a tu ordenador para destruirlo.
...
Con esta nota completamos el **Bloque 8 (Seguridad Básica e Intermedia)**. Hemos aprendido:
...
En el **Bloque 9 (Diagnóstico, Monitorización y Laboratorio Práctico)**, abriremos nuestra caja de herramientas: comenzaremos con [[09.1 - Comandos Esenciales de Diagnóstico de Red (Linux y Windows)]] para convertirnos en expertos de la consola de comandos.
