#redes #ccna #switches #cam-table #vlans #802-1q #stp #spanning-tree

> [!info] 🧭 Navegación
> ◀ [[🔗 02.2 - Protocolos y Dispositivos de Enlace (Ethernet, MAC y CSMA)]] · 🔼 [[🌐 00 - Índice Maestro de Redes Informáticas]] · ▶ [[🌐 03.1 - Protocolo IP y Direccionamiento IPv4]]
...
### ⚖️ Dominios de Colisión vs. Dominios de Difusión (*Broadcast*)
...
## ⚖️ 2. El Cerebro del Switch: La Tabla CAM y los Cuatro Verbos de la Conmutación
...
## ⚖️ 4. Puertos de Acceso vs. Enlaces Troncales (Trunk - IEEE 802.1Q)
...
### 🏛️ ¿Por qué los bucles son mortales en Capa 2?
...
## 🛡️ 6. Perspectiva de Ciberseguridad: Ataques de Capa 2
...
En Linux puedo crear switches virtuales (bridges) y configurar interfaces con etiquetas VLAN 802.1Q directamente con el comando `ip`:
...
Con esta nota cierro el **Bloque 2**. Ahora domino:
...
En el **Bloque 3** abandono la red local para entender cómo conecto el mundo entero: entro en la **Capa 3** con [[🌐 03.1 - Protocolo IP y Direccionamiento IPv4]].
