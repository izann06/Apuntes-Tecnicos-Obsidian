#redes #moc #dashboard #indice #ccna #networking #ciberseguridad

> [!abstract] 🧠 Mi Centro de Mando y Mapa de Contenido (MOC)
> ¡Mi mapa interactivo y cuaderno de bitácora de **Redes Informáticas desde Cero**! 
> He diseñado esta bóveda con un **enfoque pedagógico ascendente (bottom-up)**: parto de cómo los electrones y pulsos de luz viajan por cables y antenas, escalo capa a capa por los modelos OSI y TCP/IP hasta los servicios en la nube, y culmino con defensas perimetrales, auditorías de tráfico y laboratorios prácticos.
> 
...
| **01.3** | **Modelos de Referencia** | [[🏛️ 01.3 - Modelos de Referencia (OSI vs TCP-IP y Encapsulación)]] | Comparativa entre las 7 capas de OSI y las 4 de TCP/IP, y el viaje de empaquetado de las PDUs (Datos, Segmento, Paquete, Trama, Bits). |
...
| **03.4** | **Protocolos de Soporte L3** | [[🛠️ 03.4 - Protocolos de Soporte en Capa 3 (ARP e ICMP)]] | Resolución IP a MAC mediante ARP (con su riesgo de envenenamiento) y mensajes de diagnóstico y control con ICMP (`ping`/`traceroute`). |
...
| **05.4** | **Comparativa y Evolución** | [[⚖️ 05.4 - Comparativa TCP vs UDP y Evolución Moderna]] | Tabla comparativa definitiva entre fiabilidad y velocidad, con análisis de casos prácticos en producción e impacto en ciberseguridad. |
...
| # | Tema | Nota | Descripción en una línea |
|:---:|:---|:---|:---|
| **08.1** | **Amenazas Comunes en Redes** | [[☣️ 08.1 - Amenazas Comunes en Redes (Ataques Capas 2, 3 y 4)]] | Anatomía y mitigación de ataques reales: ARP Poisoning, inundación CAM, DHCP Starvation, IP Spoofing, SYN Flood y Man-in-the-Middle. |
| **08.2** | **Mecanismos de Protección** | [[🛡️ 08.2 - Mecanismos de Protección y Filtrado (ACLs, Firewalls y Zonas)]] | Listas de Control de Acceso (ACLs estándar y extendidas), firewalls Stateless vs Stateful, inspección profunda NGFW y diseño de zonas DMZ. |
| **08.3** | **VPNs (Redes Privadas Virtuales)**| [[🛡️ 08.3 - VPNs (Redes Privadas Virtuales, IPsec y WireGuard)]] | Criptografía aplicada al tráfico: túneles Site-to-Site vs Remote Access, análisis de IPsec (IKEv2, ESP), OpenVPN y la agilidad de WireGuard. |
...
## 🧭 ¿Cómo estudio y navego mi bóveda?

> [!tip] 💡 Tres rutas de estudio según mi objetivo
> 
> 1. **Ruta "Desde Cero" a CCNA (Recomendada)**: 
>    Sigo el orden numérico estricto del Bloque 01 al Bloque 09. Cada nota construye sobre la base de la anterior y me prepara para razonar la red de abajo hacia arriba.
> 
> 2. **Ruta Ciberseguridad y Pentesting**:
>    Empiezo por [[🏛️ 01.3 - Modelos de Referencia (OSI vs TCP-IP y Encapsulación)]], domino [[🔗 02.2 - Protocolos y Dispositivos de Enlace (Ethernet, MAC y CSMA)]] y [[🛠️ 03.4 - Protocolos de Soporte en Capa 3 (ARP e ICMP)]], y salto directamente al [[☣️ 08.1 - Amenazas Comunes en Redes (Ataques Capas 2, 3 y 4)]] y [[🦈 09.2 - Análisis de Tráfico de Red con Wireshark y Tcpdump]].
> 
> 3. **Ruta Sysadmin / DevOps / Troubleshooting**:
>    Me dirijo a los bloques de transporte y servicios: [[🚪 05.1 - Conceptos de Capa 4 (Puertos, Sockets y Multiplexación)]], [[📖 06.1 - DNS (Domain Name System - Jerarquía, Consultas y Registros)]], [[🔁 06.3 - NAT, PAT y CGNAT (Traducción de Direcciones de Red)]] y la caja de herramientas de [[🧰 09.1 - Comandos Esenciales de Diagnóstico de Red (Linux y Windows)]].

---

## 🏷️ La Regla de Oro de la Documentación en Redes

> [!brain] 🔬 Por cada protocolo documentado en mis notas, analizo:
