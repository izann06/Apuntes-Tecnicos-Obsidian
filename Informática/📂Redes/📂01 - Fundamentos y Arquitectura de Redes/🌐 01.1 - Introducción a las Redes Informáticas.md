#redes #ccna #topologias #pan #lan #wan #fundamentos

> [!info] 🧭 Navegación
> ◀ [[🌐 00 - Índice Maestro de Redes Informáticas]] · 🔼 [[🌐 00 - Índice Maestro de Redes Informáticas]] · ▶ [[⚡ 01.2 - Principios de Comunicación y Rendimiento]]
...
> Imagina una casa aislada en la montaña sin camino ni buzón: todo lo que produce se queda allí y nada de fuera puede entrar. Una red informática es como construir una calle que conecta mi casa con las de tus vecinos, con tiendas y con centros de distribución. 
...
## 🗺️ 2. Clasificación de Redes según su Alcance Geográfico
...
### ⚖️ Tabla Comparativa de Tipos de Redes
...
| **LAN** | *Local Area Network* | Un edificio o piso (< 1 km) | Ethernet (Cat6/Cat6a), Wi-Fi (802.11) | 1 Gbps a 10 Gbps | Propia (Privada) | La red de mi casa con el router, PC, SmartTV y móviles. |
...
## ⚖️ 3. Topologías Físicas vs. Topologías Lógicas
...
## 🛡️ 5. Perspectiva de Ciberseguridad (Pentesting Mindset)
...
> 1. **Inundar la tabla CAM del switch (*MAC Flooding*)**: Provocar que el switch se quede sin memoria RAM para recordar qué MAC está en qué puerto y comience a operar como un viejo *hub*, retransmitiendo todo el tráfico por todos los puertos para capturarlo con Wireshark ([[☣️ 08.1 - Amenazas Comunes en Redes (Ataques Capas 2, 3 y 4)]]).
> 2. **Ejecutar un ataque Man-in-the-Middle vía ARP Spoofing**: Engañar a los vecinos y al switch haciéndose pasar por el router ([[🛠️ 03.4 - Protocolos de Soporte en Capa 3 (ARP e ICMP)]]).
> 
...
Para inspeccionar cómo tu sistema operativo detecta su interfaz física, su estado y los enlaces activos de su red local, ejecuta en mi terminal:
...
# 4. Descubrir vecinos en mi red local inmediata (requiere privilegios de root)
...
En esta nota he aprendido qué define una red, la escala que abarca (desde centímetros en una PAN hasta el planeta en una WAN) y por qué la topología en estrella domina las redes locales y la malla parcial domina Internet.

En la siguiente nota ([[⚡ 01.2 - Principios de Comunicación y Rendimiento]]), profundizo en **cómo se transmiten los datos**: simplex vs dúplex, conmutación de circuitos vs paquetes, y las cuatro métricas que determinan la calidad real de mi conexión: ancho de banda, latencia, jitter y pérdida de paquetes.
