#redes #ccna #osi #tcp-ip #encapsulacion #pdu #wireshark

> [!info] 🧭 Navegación
> ◀ [[⚡ 01.2 - Principios de Comunicación y Rendimiento]] · 🔼 [[🌐 00 - Índice Maestro de Redes Informáticas]] · ▶ [[🔌 02.1 - Medios de Transmisión y Capa Física]]

---

## 🏛️ 1. ¿Por Qué Necesitamos Modelos de Capas?
...
## 🏛️ 2. El Modelo OSI (Open Systems Interconnection)
...
### 🏛️ Descripción Detallada de las 7 Capas OSI
...
## 🏛️ 4. El Proceso de Encapsulación y Desencapsulación
...
## 🛡️ 6. Perspectiva de Ciberseguridad: Diagnóstico y Ataques por Capa
...
> - **Ataques en Capa 2**: [[☣️ 08.1 - Amenazas Comunes en Redes (Ataques Capas 2, 3 y 4)]] (MAC Flooding, ARP Spoofing). Aquí los routers no pueden protegerte porque todo ocurre dentro de la LAN.
...
Puedo ver la encapsulación en directo realizando una petición HTTP y analizando cómo viaja por las capas:
...
Con esta nota completo el **Bloque 1**. Ahora posees una base sólida sobre:
