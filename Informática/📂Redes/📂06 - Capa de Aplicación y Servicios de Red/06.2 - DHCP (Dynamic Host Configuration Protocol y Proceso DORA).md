...
aliases:
  - "DHCP (Dynamic Host Configuration Protocol y Proceso DORA)"
  - "Asignación Dinámica de IP y Seguridad DHCP Snooping"
date: 2026-09-07
---

> [!info] 🧭 Navegación
> ◀ [[06.1 - DNS (Domain Name System - Jerarquía, Consultas y Registros)]] · 🔼 [[00 - Índice Maestro de Redes]] · ▶ [[06.3 - NAT, PAT y CGNAT (Traducción de Direcciones de Red)]]

---

# 📡 06.2 - DHCP (Dynamic Host Configuration Protocol y Proceso DORA)

## 1. El Propósito de DHCP: Automatizando la Configuración de Red

Configurar manualmente una dirección IP, máscara de subred, puerta de enlace predeterminada y servidores DNS en 5 ordenadores es una tarea sencilla. Hacerlo en una empresa con 1.500 empleados, portátiles que van y vienen de reuniones y teléfonos móviles que se conectan a la Wi-Fi es una pesadilla inviable propensa a conflictos humanos de IP duplicada.
...
## 4. DHCP Relay Agent: Cruzando Fronteras de Enrutadores
...
## 5. Perspectiva de Ciberseguridad: Ataques y Defensas en DHCP
...
En la siguiente nota ([[06.3 - NAT, PAT y CGNAT (Traducción de Direcciones de Red)]]), veremos la tecnología que permitió que miles de millones de dispositivos naveguen por Internet utilizando una sola dirección IP pública: **NAT y sobrecarga PAT**.
