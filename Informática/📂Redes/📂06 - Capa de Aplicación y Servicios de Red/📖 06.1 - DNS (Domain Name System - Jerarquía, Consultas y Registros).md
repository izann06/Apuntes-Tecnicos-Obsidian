#redes #ccna #dns #registros-dns #dig #dnssec #ciberseguridad

> [!info] 🧭 Navegación
> ◀ [[⚖️ 05.4 - Comparativa TCP vs UDP y Evolución Moderna]] · 🔼 [[🌐 00 - Índice Maestro de Redes Informáticas]] · ▶ [[📡 06.2 - DHCP (Dynamic Host Configuration Protocol y Proceso DORA)]]
...
## ☁️ 2. La Jerarquía Global del Árbol DNS
...
4. **Recursive Resolvers (Resolvedores Recursivos / DNS Caché)**:
   - Los servidores a los que apunta mi ordenador (el DNS de tu proveedor de Internet o servicios públicos como Cloudflare `1.1.1.1` o Google `8.8.8.8`). Hacen todo el trabajo de consultar la jerarquía por ti y guardan las respuestas en memoria RAM (**Caché**) para responder al instante la próxima vez.

---

## ⚖️ 3. Resolución Recursiva vs. Iterativa: El Viaje de una Consulta
...
## ☁️ 4. Tipos de Registros DNS Esenciales
...
## ☁️ 5. El TTL (Time to Live) en DNS: La Espada de Doble Filo
...
## 🛡️ 6. Perspectiva de Ciberseguridad: Ataques sobre DNS
...
> Al ejecutar `dig +trace`, verás cómo mi terminal contacta primero con uno de los servidores raíz (`k.root-servers.net`), luego salta al TLD (`a.org-servers.net`) y finalmente obtiene la respuesta del autoritativo de Wikimedia. ¡El proceso iterativo desplegado ante tus ojos!
