#redes #ccna #protocolos-aplicacion #http #https #ssh #ftp #smtp #snmp #wireshark

> [!info] 🧭 Navegación
> ◀ [[🔁 06.3 - NAT, PAT y CGNAT (Traducción de Direcciones de Red)]] · 🔼 [[🌐 00 - Índice Maestro de Redes Informáticas]] · ▶ [[📡 07.1 - Estándares IEEE 802.11 (De Wi-Fi 4 a Wi-Fi 7)]]

---

## 🖥️ 1. La Capa de Aplicación (Capa 7 OSI): Donde Trabaja el Usuario

La **Capa de Aplicación** proporciona la interfaz directa entre el software que utilizo (navegadores web, terminales de administración, clientes de correo) y la infraestructura de red subyacente.

En esta nota desgloso los protocolos estándar más importantes de la industria, agrupados por su propósito operativo: **Web**, **Administración Remota**, **Transferencia de Archivos**, **Correo Electrónico** y **Gestión de Infraestructura**.

---

## ⚖️ 2. Protocolos Web: HTTP vs. HTTPS
...
### ☁️ Códigos de Estado HTTP Esenciales
...
## ⚖️ 3. Administración Remota: SSH vs. Telnet
...
## ☁️ 4. Transferencia de Archivos: FTP, SFTP y TFTP
...
## ☁️ 5. Correo Electrónico: La Tríada SMTP, IMAP y POP3
...
3. **POP3 (*Post Office Protocol* - Puerto 110 / POP3S 995)**:
   - Protocolo antiguo de descarga. Descarga los correos a mi ordenador local y los borra del servidor por defecto. Inadecuado para el uso actual multidispositivo.

---

## ☁️ 6. Gestión, Tiempo y Monitorización: NTP y SNMP
...
## 🛡️ 7. Perspectiva de Ciberseguridad: Auditoría de Protocolos L7
...
Con esta nota culmino el **Bloque 6 (Capa de Aplicación y Servicios)**. He dominado:
