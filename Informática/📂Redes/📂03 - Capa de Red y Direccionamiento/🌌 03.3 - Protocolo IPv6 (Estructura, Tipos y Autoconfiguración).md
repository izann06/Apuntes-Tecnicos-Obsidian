#redes #ccna #ipv6 #slaac #link-local #gua #eui-64

> [!info] 🧭 Navegación
> ◀ [[🧮 03.2 - Subnetting y VLSM (Cálculo Práctico de Subredes)]] · 🔼 [[🌐 00 - Índice Maestro de Redes Informáticas]] · ▶ [[🛠️ 03.4 - Protocolos de Soporte en Capa 3 (ARP e ICMP)]]

---

## 🌌 1. ¿Por Qué Nació IPv6? La Muerte del Espacio IPv4

En febrero de 2011, la autoridad central de asignación de números de Internet (**IANA**) entregó los últimos cinco bloques `/8` de direcciones IPv4 a los Registros Regionales de Internet (RIRs).
...
## ⚖️ 5. Autoconfiguración: SLAAC vs. DHCPv6
...
## 🛡️ 6. Perspectiva de Ciberseguridad: Amenazas en IPv6
...
En la siguiente nota ([[🛠️ 03.4 - Protocolos de Soporte en Capa 3 (ARP e ICMP)]]), analizo los dos protocolos de soporte vitales sin los cuales la Capa 3 no podría operar: la resolución de direcciones con **ARP** y los diagnósticos con **ICMP**.
