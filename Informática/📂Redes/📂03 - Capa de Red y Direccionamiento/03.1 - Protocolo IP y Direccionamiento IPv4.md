...
aliases:
  ...
  - "Cabecera IPv4 y Direcciones Privadas RFC 1918"
date: 2026-09-07
---

> [!info] 🧭 Navegación
> ◀ [[02.3 - Conmutación, Switches, VLANs y Spanning Tree (STP)]] · 🔼 [[00 - Índice Maestro de Redes]] · ▶ [[03.2 - Subnetting y VLSM (Cálculo Práctico de Subredes)]]

---

# 🌐 03.1 - Protocolo IP y Direccionamiento IPv4

## 1. El Protocolo IP: El Pegamento Universal de Internet

El **Protocolo de Internet** (**IP** - *Internet Protocol*) opera en la **Capa 3 (Red)** y es el corazón de la arquitectura TCP/IP. Mientras las direcciones MAC solo sirven para comunicarse dentro de una misma acera o calle local (LAN), las direcciones IP permiten que los datos viajen entre distintas ciudades, países y continentes a través de routers intermedios.
...
7. **Protocol (8 bits)**: Indica a qué protocolo de Capa 4 se deben entregar los datos al llegar:
   - `1`: ICMP ([[03.4 - Protocolos de Soporte en Capa 3 (ARP e ICMP)]])
...
## 4. Direcciones IP Privadas (RFC 1918) vs. Direcciones Públicas
...
2. **APIPA / Enlace Local (*Automatic Private IP Addressing* - `169.254.0.0/16`)**:
   - Si tu ordenador tiene configurado obtener IP por DHCP pero el servidor DHCP está caído o el cable no recibe respuesta, el sistema operativo (Windows/Linux/macOS) se autoasigna una IP en el rango `169.254.x.x`.
   - > [!warning] 🚨 Síntoma Clásico de Soporte Técnico
     > Si ves que tu ordenador tiene la IP `169.254.45.89`, **tu servidor DHCP no te está respondiendo**. Tienes enlace físico (Capa 1/2), pero nadie te asignó configuración en Capa 3.
...
En la siguiente nota ([[03.2 - Subnetting y VLSM (Cálculo Práctico de Subredes)]]), entraremos en el cálculo matemático de subredes: aprenderás a calcular máscaras CIDR, direcciones de red, broadcast y cómo diseñar esquemas eficientes con **VLSM** en cuestión de segundos.
