...
aliases:
  - "Protocolo UDP (Datagramas y Rendimiento)"
  - "UDP, Streaming y la Revolución de QUIC / HTTP3"
date: 2026-09-07
---

> [!info] 🧭 Navegación
> ◀ [[05.2 - Protocolo TCP (3-Way Handshake, Flujo y Confiabilidad)]] · 🔼 [[00 - Índice Maestro de Redes]] · ▶ [[05.4 - Comparativa TCP vs UDP y Evolución Moderna]]

---

# ⚡ 05.3 - Protocolo UDP (Datagramas, Rendimiento y QUIC)
...
## 5. Perspectiva de Ciberseguridad: Ataques de Amplificación y Reflexión UDP
...
En la siguiente nota ([[05.4 - Comparativa TCP vs UDP y Evolución Moderna]]), consolidaremos el Bloque 5 con una **matriz comparativa exhaustiva**, criterios de decisión técnica para arquitectura y el futuro del transporte de datos.
