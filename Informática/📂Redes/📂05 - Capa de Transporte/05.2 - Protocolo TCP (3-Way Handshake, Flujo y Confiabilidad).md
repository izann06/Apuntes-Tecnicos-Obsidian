...
aliases:
  - "Protocolo TCP (3-Way Handshake y Confiabilidad)"
  - "Funcionamiento de TCP, Flags y Control de Flujo"
date: 2026-09-07
---

> [!info] 🧭 Navegación
> ◀ [[05.1 - Conceptos de Capa 4 (Puertos, Sockets y Multiplexación)]] · 🔼 [[00 - Índice Maestro de Redes]] · ▶ [[05.3 - Protocolo UDP (Datagramas, Rendimiento y QUIC)]]

---

# 🤝 05.2 - Protocolo TCP (3-Way Handshake, Flujo y Confiabilidad)

## 1. ¿Qué es TCP y Por Qué Gobierna Internet?

El protocolo **TCP** (*Transmission Control Protocol* - RFC 793) es el caballo de batalla de Internet. Si estás descargando un ejecutable de software, haciendo una transferencia bancaria o navegando por una página web, **no puedes permitirte perder ni un solo byte**: un solo bit corrupto corrompería el programa entero.
...
## 6. Perspectiva de Ciberseguridad: Ataques sobre TCP
...
En la siguiente nota ([[05.3 - Protocolo UDP (Datagramas, Rendimiento y QUIC)]]), exploraremos la otra cara de la moneda: el protocolo **UDP**, la velocidad sin ataduras y cómo el nuevo estándar **QUIC / HTTP/3** está revolucionando el transporte moderno.
