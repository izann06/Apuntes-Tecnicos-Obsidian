#redes #ccna #capa-transporte #puertos #sockets #multiplexacion #quintupla #nmap

> [!info] 🧭 Navegación
> ◀ [[🚀 04.2 - Protocolos de Enrutamiento Dinámico (RIP, OSPF y BGP)]] · 🔼 [[🌐 00 - Índice Maestro de Redes Informáticas]] · ▶ [[🤝 05.2 - Protocolo TCP (3-Way Handshake, Flujo y Confiabilidad)]]

---

## 🚪 1. El Rol de la Capa de Transporte: Comunicación Proceso a Proceso

Hasta ahora he aprendido cómo viajan los paquetes entre ordenadores a través del direccionamiento IP (Capa 3). Sin embargo, mi ordenador no es un bloque monolítico: en este instante tengo abierto el navegador web con 15 pestañas, la aplicación de Discord, Spotify reproduciendo música y una sesión de SSH abierta en mi terminal.

Si llega un paquete IP a la tarjeta de red de mi ordenador... **¿cómo sabe el sistema operativo a qué programa concreto debe entregárselo?**
...
- Cuando tu navegador entra a `https://google.com`, el puerto destino es el `443` (fijo y conocido), pero el puerto de mi ordenador es un puerto efímero aleatorio (ej. `52189`). Cuando cierras la pestaña, ese puerto se libera de inmediato.
...
## 🛡️ 4. Perspectiva de Ciberseguridad: Auditoría y Escaneo de Puertos con Nmap
...
En la siguiente nota ([[🤝 05.2 - Protocolo TCP (3-Way Handshake, Flujo y Confiabilidad)]]), analizo a fondo el protocolo que garantiza que ningún archivo llegue corrupto a destino: **TCP**, su famoso **saludo de tres vías** y el control de flujo con ventana deslizante.
