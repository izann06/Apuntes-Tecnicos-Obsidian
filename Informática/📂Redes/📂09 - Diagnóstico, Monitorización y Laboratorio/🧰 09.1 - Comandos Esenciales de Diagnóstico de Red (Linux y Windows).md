#redes #ccna #diagnostico #comandos-red #linux #windows #troubleshooting #sysadmin

> [!info] 🧭 Navegación
> ◀ [[🛡️ 08.3 - VPNs (Redes Privadas Virtuales, IPsec y WireGuard)]] · 🔼 [[🌐 00 - Índice Maestro de Redes Informáticas]] · ▶ [[🦈 09.2 - Análisis de Tráfico de Red con Wireshark y Tcpdump]]
...
El comando `ping` envía paquetes `ICMP Echo Request` (Type 8) y espera `Echo Reply` (Type 0) ([[🛠️ 03.4 - Protocolos de Soporte en Capa 3 (ARP e ICMP)]]):
...
### ☁️ 3.3 `dig`: Inspección Quirúrgica del Sistema DNS
...
### 🛡️ 3.4 `ss`: Auditoría de Sockets y Puertos en Vivo
...
## 🛡️ 4. Perspectiva de Ciberseguridad: Living-off-the-Land (LotL)
