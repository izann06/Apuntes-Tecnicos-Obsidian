#redes #ccna #wireshark #tcpdump #tshark #sniffing #analisis-trafico #bpf #ciberseguridad

> [!info] 🧭 Navegación
> ◀ [[🧰 09.1 - Comandos Esenciales de Diagnóstico de Red (Linux y Windows)]] · 🔼 [[🌐 00 - Índice Maestro de Redes Informáticas]] · ▶ [[🧪 09.3 - Entornos de Simulación y Laboratorio (Packet Tracer, GNS3 y EVE-NG)]]
...
## ⚖️ 3. Tcpdump vs. Wireshark vs. Tshark
...
## ⚖️ 4. La Gran Diferencia: Filtros de Captura (BPF) vs. Filtros de Visualización
...
## 🛡️ 7. Perspectiva de Ciberseguridad: Captura en Entornos Conmutados (Switched Networks)
...
>    Si el atacante no tiene acceso al switch para hacer SPAN, utiliza **ARP Spoofing** ([[☣️ 08.1 - Amenazas Comunes en Redes (Ataques Capas 2, 3 y 4)]]) para forzar al switch a enviarle todo el tráfico de la víctima directamente a su tarjeta de red.
