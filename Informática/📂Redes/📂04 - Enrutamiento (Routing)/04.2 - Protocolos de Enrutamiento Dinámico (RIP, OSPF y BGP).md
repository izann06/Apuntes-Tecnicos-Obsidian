...
tags:
  ...
  - ciberseguridad
folder: "📂04 - Enrutamiento (Routing)"
aliases:
  - "Protocolos de Enrutamiento Dinámico (RIP, OSPF y BGP)"
  - "OSPF, Áreas, Algoritmo Dijkstra y BGP en Internet"
date: 2026-09-07
---

> [!info] 🧭 Navegación
> ◀ [[04.1 - Fundamentos de Routers y Enrutamiento Estático]] · 🔼 [[00 - Índice Maestro de Redes]] · ▶ [[05.1 - Conceptos de Capa 4 (Puertos, Sockets y Multiplexación)]]

---

# 🚀 04.2 - Protocolos de Enrutamiento Dinámico (RIP, OSPF y BGP)

## 1. ¿Por Qué Enrutamiento Dinámico?

En una red empresarial con 80 routers o en la inmensidad de Internet con más de 100.000 sistemas autónomos, el enrutamiento estático es inviable: si un cable de fibra submarina se corta en el Canal de la Mancha, ningún humano puede entrar a modificar a mano miles de routers en milisegundos.
...
### Tabla de Distancia Administrativa (Cisco Default AD)
...
## 6. Perspectiva de Ciberseguridad: BGP Hijacking y Ataques de Enrutamiento
...
En Linux, los routers de producción utilizan suites profesionales de enrutamiento como **FRRouting (FRR)** o **BIRD**. Sin embargo, podemos consultar las rutas BGP de Internet en vivo conectándonos a servidores públicos de consulta llamados **Looking Glasses**:
...
Con esta nota cerramos el **Bloque 4**. Hemos dominado:
