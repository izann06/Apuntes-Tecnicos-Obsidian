...
Las computadoras no entienden de palabras, solo de números (Direcciones IP como `192.0.2.44`). Los humanos somos malísimos recordando números, así que usamos nombres (Dominios como `www.cafeteria.com`).
