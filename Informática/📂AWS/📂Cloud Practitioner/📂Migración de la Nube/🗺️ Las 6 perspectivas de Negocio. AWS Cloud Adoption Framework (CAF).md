...
**Tags:** #aws #caf #migracion #estrategia #cloud-practitioner #cp-migracion-de-la-nube

> [!summary] El Concepto Clave
> Migrar a la nube cambia por completo cómo funciona una empresa. **AWS Cloud Adoption Framework (AWS CAF)** es una guía de buenas prácticas que ayuda a las organizaciones a planificar esta transición sin olvidar a ningún departamento. Divide a la empresa en **6 "Perspectivas"** (áreas de responsabilidad) para asegurar que todos reman en la misma dirección.


---

## 🏢 1. Perspectivas de Negocio (Enfoque Organizacional)
...
## 💻 2. Perspectivas Técnicas (Enfoque de Infraestructura)
...
## 🎯 Chuleta Rápida para el Examen (Emparejamientos)

En el examen te describirán a un profesional o un problema y te pedirán que identifiques a qué "Perspectiva del CAF" pertenece:

| Si la pregunta menciona... | La perspectiva de AWS CAF es... |
| :--- | :--- |
| Capacitar empleados, RRHH, gestión del cambio corporativo. | **Personas (People)** |
| Crear el caso de negocio, vincular TI con resultados financieros. | **Empresas (Business)** |
| Minimizar riesgos empresariales, maximizar valor, el CIO. | **Gobernanza (Governance)** |
| Patrones arquitectónicos, diseño del sistema de destino, CTO. | **Plataforma (Platform)** |
| Controles de acceso, protección de datos, CISO. | **Seguridad (Security)** |
| Soporte diario, recuperación de cargas de trabajo, mantenimiento. | **Operaciones (Operations)** |
