...
| :--- | :--- | :--- | :--- | :--- |
| **Amazon Rekognition** | 🖼️ Imagen / 🎥 Vídeo | Etiquetas, caras, texto, objetos, emociones | Visión por ordenador en imágenes y vídeo en tiempo real | `análisis de imágenes`, `verificación identidad`, `content moderation`, `PPE detection` |
